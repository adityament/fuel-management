...
export default function StaffAttendancePage() {
 ...
 const handleCheckIn = async () => {
  try {
    ...
    const res = await fetch(`${BASE_URL}/api/attendance/markattendance`, {
      method: "POST",
      headers: {
  ...
  const columns = [
    {
      key: "date",
      header: "Date",
      render: (item: Attendance) => new Date(item.date).toLocaleDateString(),
    },
    {
      key: "timeIn",
      header: "Check-in",
      render: (item: Attendance) => new Date(item.timeIn).toLocaleTimeString(),
    },
    {
      key: "timeOut",
      header: "Check-out",
    ...
    },
    {
      key: "workedHours",
      header: "Worked Hours",
      render: (item: Attendance) => formatWorkedHours(item.workedHours),
    },
    {
      key: "notes",
      header: "Notes",
