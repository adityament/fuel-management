...
import { LayoutDashboard, Users, ShoppingCart, Clock, Package, UserCircle, Shield, BadgeInfo } from "lucide-react"
...
export function MobileNav() {
  ...
  const items = navItems[role].slice(0, 7) // Changed to 6 so Profile shows for admin
